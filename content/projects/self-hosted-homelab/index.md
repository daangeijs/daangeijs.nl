...
- **Dockerized services** with [automated database backups](/posts/mariadb-backup/) and a [tested restore path](/posts/dockerized-backup/) — a backup you've never restored is a rumour, not a backup.
