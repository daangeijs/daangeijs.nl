...
<GitHubCard url="https://github.com/daangeijs/pathology-cell-density" name="pathology-cell-density" description="A demonstration script for analyzing cell density in whole slide images (WSIs)." language="Jupyter Notebook" stars="1" forks="0" />
